...
def main():
    ...
    pygame.display.set_caption("CARLA RGB Camera (live) — press ESC to quit")
    ...
    print(f"📁 Saving images to: {os.path.abspath(OUTPUT_DIR)} (every {SAVE_EVERY_N_FRAMES} frames)")
    ...
    try:
        ...
        pygame.quit()
        print("✅ Cleaned up (camera + vehicle destroyed). Done.")
